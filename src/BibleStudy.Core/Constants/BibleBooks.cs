namespace BibleStudy.Core.Constants;

/// <summary>
/// Constant names of Bible books for faster finding
/// </summary>
public static class BibleBooks
{
    // public static readonly IReadOnlyList<string> AllNames = new List<string>
    // {
